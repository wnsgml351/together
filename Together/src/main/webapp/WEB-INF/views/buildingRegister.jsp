			...
			<div class="row">
				...
				<div class="col-sm-8" style="background-color: lavenderblush;">
					...
					<div class="form-group" style="width: 10%">
						<label for="inputdefault">이름</label> <input class="form-control" id="inputName" type="text" name="b_name">
					</div>

					<div class="form-group" style="width: 60%">
						<label for="inputdefault">주소</label> <input class="form-control" id="address" type="text" name="b_address">
					</div>
